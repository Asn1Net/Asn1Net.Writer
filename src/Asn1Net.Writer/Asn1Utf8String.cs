...
namespace Net.Asn1.Writer
{
    ...
    /// <summary>
    /// Implementation of ASN.1 UTF8 STRING
    /// </summary>
    public class Asn1Utf8String : Asn1Object<string>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Asn1Utf8String"/> class.
        /// </summary>
        /// <param name="content">Content to be encoded.</param>
        public Asn1Utf8String(string content)
            : base(Asn1Class.Universal, false, (int)Asn1Type.Utf8String, content)
        {
        }
